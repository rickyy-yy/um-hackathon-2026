...
class Settings(BaseSettings):
    ...
    database_url: str = Field(
        default="postgresql+asyncpg://kira2je_user:change_me_db_password@db:5432/kira2je",
        alias="DATABASE_URL",
    )
    sync_database_url: str = Field(
        default="postgresql://kira2je_user:change_me_db_password@db:5432/kira2je",
    ...
    smtp_from: str = Field(default="no-reply@kira2je.local", alias="SMTP_FROM")
